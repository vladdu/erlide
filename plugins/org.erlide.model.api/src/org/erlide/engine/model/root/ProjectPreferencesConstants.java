...
public final class ProjectPreferencesConstants {
    ...
    public static final RuntimeVersion DEFAULT_RUNTIME_VERSION = new RuntimeVersion(24);
    public static final RuntimeVersion[] SUPPORTED_VERSIONS = { new RuntimeVersion(21),
            new RuntimeVersion(22), new RuntimeVersion(23), new RuntimeVersion(24) };
